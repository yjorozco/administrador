...
CREATE SEQUENCE public.encuesta_detalle_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.encuesta_detalle_id_seq OWNER TO postgres;
...
CREATE TABLE public.encuestas (
    id integer DEFAULT nextval('public.encuesta_id_seq'::regclass) NOT NULL,
...
--
-- Name: encuestas_detalles; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.encuestas_detalles OWNER TO postgres;

--
-- Name: intensidades_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.intensidades_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.intensidades_id_seq OWNER TO postgres;

--
-- Name: intensidades; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.intensidades (
    id integer DEFAULT nextval('public.intensidades_id_seq'::regclass) NOT NULL,
    nombre character varying(10) NOT NULL,
    valor integer NOT NULL
);


ALTER TABLE public.intensidades OWNER TO postgres;
...
--
-- Name: preguntas_intensidades; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.preguntas_intensidades OWNER TO postgres;

--
-- Name: preguntas_intensidades_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.preguntas_intensidades_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.preguntas_intensidades_id_seq OWNER TO postgres;

--
-- Name: preguntas_intensidades_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.preguntas_intensidades_id_seq OWNED BY public.preguntas_intensidades.id;
...
--
-- Name: preguntas_intensidades id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.preguntas_intensidades ALTER COLUMN id SET DEFAULT nextval('public.preguntas_intensidades_id_seq'::regclass);
...
COPY public.ciudad (nombre, pais, provincia, poblacion, longitud, latitud) FROM stdin;
...
COPY public.encuestas (id, fecha, id_usuarios, pais, estado, ciudad, codigo, intensidad) FROM stdin;
1	2016-05-24 15:54:14+00	99	\N	\N	\N	\N	I
\.
...
COPY public.intensidades (id, nombre, valor) FROM stdin;
2	-	0
3	I	1
4	II	2
5	III	3
...
COPY public.pais (nombre, codigo, capital, provincia, area, poblacion) FROM stdin;
...
COPY public.provincia (nombre, pais, poblacion, area, capital, cap_prov) FROM stdin;
...
77	Pedro	Perez	\N	Maracaibo	333333	pperez@gmail.com	$2b$10$u0Y4Lr2WOSLZMZ3YOYTEM.CbxL2Apj2zMYEJgEdBUJ9w3jzQQ6uTu	f	e69d62f4a1
82	Pedro	Perez	\N	Maracaibo	333333	uuu@gmail.com	$2b$10$2tcteRf7WfzGO0Ir143AiOF000sxI3ol75wpstu2w3/Myaycxrzxq	f	aff9cf80f4
84	Pedro	Perez	\N	Maracaibo	333333	uuu1@gmail.com	$2b$10$u3r48P/IgjBRpTnfWQZhmucSECdAevhPz6B1E71dLgZ0hISQKNtDy	f	11ccdb9782
85	Pedro	Perez	\N	Maracaibo	333333	uu2u1@gmail.com	$2b$10$tcOfc1DkSov3.Z1UJLsFQ.gVsjk/yAjS1nHUryPKQUE/UyrrneZVe	f	d3b879925b
86	Pedro	Perez	\N	Maracaibo	333333	uu222u1@gmail.com	$2b$10$KC1zADfXVjHoGHensIj4Iuw7XCPNzVW.XQKb5GjwRxOkZ.8KjBDGq	f	ccc7058612
100	yamil	orozco		esquina pineda a toro piso	0212-8606877	yamiloro1112@gmail.com	$2b$10$WLshZKTYxsLuQuJ.mrJuxeHyTjzS2yijB9/h4Xio/swMIA4yhDFMS	t	\N
104	yamil	orozco	avatar.png	esquina pineda a toro piso	0212-8606877	yamiloro221112@gmail.com	$2b$10$lwVcmFripPoxLYMsdP715uFrGogIO2sb812MAx6g/F94WkV4kV1G2	t	\N
106	yamil	orozco		esquina pineda a toro piso	0212-8606877	yamiloro22ww1112@gmail.com	$2b$10$eO/aNqctQ7J/x8qKh8MBpuK0WdJsjvv4bBXg2/BdK49cyZ2wleKIm	t	\N
111	yamil	orozco		esquina pineda a toro piso	0212-8606877	yamilo221112@gmail.com	$2b$10$ievTob3obqf7/ClM.0afo.QdMQtPnQ9A0LUJg9gmG/wVaU097rp82	t	\N
...
SELECT pg_catalog.setval('public.encuesta_detalle_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.intensidades_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.preguntas_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.preguntas_intensidades_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.usuarios_roles_id_seq', 76, true);
...
--
-- Name: encuestas encuesta_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: encuestas_detalles encuestas_detalles_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: intensidades intensidad_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pais pais_un; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: preguntas pk_preguntas; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: preguntas_intensidades pk_preguntas_intensidades; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.preguntas_intensidades
...
--
-- Name: preguntas_intensidades un_intensidad_preguntas; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: intensidades un_nombre_intensidades; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: intensidades un_valor_intensidades; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usuarios_correo_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX usuarios_correo_idx ON public.usuarios USING btree (correo);


--
-- Name: ciudad ciudad_provincia_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ciudad
    ADD CONSTRAINT ciudad_provincia_fk FOREIGN KEY (provincia, pais) REFERENCES public.provincia(nombre, pais) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: encuestas encuestas_ciudad_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.encuestas
    ADD CONSTRAINT encuestas_ciudad_fk FOREIGN KEY (ciudad, pais, estado) REFERENCES public.ciudad(nombre, pais, provincia) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: encuestas_detalles encuestas_detalles_encuesta_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.encuestas_detalles
    ADD CONSTRAINT encuestas_detalles_encuesta_fk FOREIGN KEY (id_encuestas) REFERENCES public.encuestas(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: encuestas encuestas_usuarios_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.encuestas
    ADD CONSTRAINT encuestas_usuarios_fk FOREIGN KEY (id_usuarios) REFERENCES public.usuarios(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: preguntas_intensidades fk_preg_inten_intensidad; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.preguntas_intensidades
    ADD CONSTRAINT fk_preg_inten_intensidad FOREIGN KEY (id_intensidades) REFERENCES public.intensidades(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: preguntas_intensidades fk_preg_inten_preguntas; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.preguntas_intensidades
    ADD CONSTRAINT fk_preg_inten_preguntas FOREIGN KEY (id_preguntas) REFERENCES public.preguntas(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: provincia provincia_pais_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.provincia
    ADD CONSTRAINT provincia_pais_fk FOREIGN KEY (pais) REFERENCES public.pais(codigo) ON UPDATE CASCADE ON DELETE RESTRICT;
