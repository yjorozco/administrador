...
-- Started on 2021-03-07 22:58:47
...
ALTER SEQUENCE public.encuesta_id_seq OWNED BY public.encuestas.id;
...
-- Name: encuestas_detalles_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.encuestas_detalles_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.encuestas_detalles_id_seq OWNER TO postgres;

--
-- TOC entry 2954 (class 0 OID 0)
-- Dependencies: 213
-- Name: encuestas_detalles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.encuestas_detalles_id_seq OWNED BY public.encuestas_detalles.id;
...
-- Name: intensidad_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.intensidad_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.intensidad_id_seq OWNER TO postgres;

--
-- TOC entry 2955 (class 0 OID 0)
-- Dependencies: 208
-- Name: intensidad_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.intensidad_id_seq OWNED BY public.intensidades.id;
...
--
-- TOC entry 2754 (class 2604 OID 16673)
-- Name: encuestas id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.encuestas ALTER COLUMN id SET DEFAULT nextval('public.encuesta_id_seq'::regclass);


--
-- TOC entry 2755 (class 2604 OID 16686)
-- Name: encuestas_detalles id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.encuestas_detalles ALTER COLUMN id SET DEFAULT nextval('public.encuestas_detalles_id_seq'::regclass);


--
-- TOC entry 2753 (class 2604 OID 16652)
-- Name: intensidades id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.intensidades ALTER COLUMN id SET DEFAULT nextval('public.intensidad_id_seq'::regclass);


--
-- TOC entry 2747 (class 2604 OID 16594)
...
--
-- TOC entry 2752 (class 2604 OID 16644)
...
--
-- TOC entry 2748 (class 2604 OID 16595)
...
--
-- TOC entry 2749 (class 2604 OID 16596)
...
--
-- TOC entry 2750 (class 2604 OID 16597)
...
--
-- TOC entry 2751 (class 2604 OID 16598)
...
--
-- TOC entry 2946 (class 0 OID 16741)
-- Dependencies: 216
...
--
-- TOC entry 2941 (class 0 OID 16670)
-- Dependencies: 211
...
--
-- TOC entry 2942 (class 0 OID 16681)
-- Dependencies: 212
...
--
-- TOC entry 2939 (class 0 OID 16649)
-- Dependencies: 209
...
--
-- TOC entry 2944 (class 0 OID 16704)
-- Dependencies: 214
...
--
-- TOC entry 2926 (class 0 OID 16566)
-- Dependencies: 196
...
8	admin_crear_roles
19	usuario_procesar_encuestas
\.


--
-- TOC entry 2937 (class 0 OID 16641)
-- Dependencies: 207
-- Data for Name: preguntas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.preguntas (id, nombre, id_intensidades) FROM stdin;
\.


--
-- TOC entry 2945 (class 0 OID 16714)
-- Dependencies: 215
...
--
-- TOC entry 2928 (class 0 OID 16571)
-- Dependencies: 198
...
--
-- TOC entry 2930 (class 0 OID 16576)
-- Dependencies: 200
...
--
-- TOC entry 2932 (class 0 OID 16581)
-- Dependencies: 202
...
--
-- TOC entry 2934 (class 0 OID 16589)
-- Dependencies: 204
...
-- Dependencies: 213
-- Name: encuestas_detalles_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.encuestas_detalles_id_seq', 1, false);


--
-- TOC entry 2964 (class 0 OID 0)
-- Dependencies: 208
-- Name: intensidad_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.intensidad_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.permisos_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.roles_permisos_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.usuarios_roles_id_seq', 46, true);


--
-- TOC entry 2792 (class 2606 OID 16747)
...
--
-- TOC entry 2782 (class 2606 OID 16675)
...
--
-- TOC entry 2780 (class 2606 OID 16657)
...
--
-- TOC entry 2786 (class 2606 OID 16711)
...
--
-- TOC entry 2788 (class 2606 OID 16713)
...
--
-- TOC entry 2763 (class 2606 OID 16600)
...
--
-- TOC entry 2765 (class 2606 OID 16602)
...
--
-- TOC entry 2768 (class 2606 OID 16604)
...
--
-- TOC entry 2774 (class 2606 OID 16608)
...
--
-- TOC entry 2790 (class 2606 OID 16735)
...
--
-- TOC entry 2776 (class 2606 OID 16612)
...
--
-- TOC entry 2761 (class 1259 OID 16634)
...
--
-- TOC entry 2766 (class 1259 OID 16635)
...
--
-- TOC entry 2769 (class 1259 OID 16637)
...
--
-- TOC entry 2772 (class 1259 OID 16638)
...
--
-- TOC entry 2804 (class 2606 OID 16753)
...
--
-- TOC entry 2798 (class 2606 OID 16772)
...
--
-- TOC entry 2800 (class 2606 OID 16699)
...
--
-- TOC entry 2801 (class 2606 OID 16787)
...
--
-- TOC entry 2802 (class 2606 OID 16792)
...
--
-- TOC entry 2799 (class 2606 OID 16777)
...
--
-- TOC entry 2793 (class 2606 OID 16613)
...
--
-- TOC entry 2794 (class 2606 OID 16618)
...
--
-- TOC entry 2795 (class 2606 OID 16623)
...
--
-- TOC entry 2796 (class 2606 OID 16628)
...
--
-- TOC entry 2797 (class 2606 OID 16658)
-- Name: preguntas preguntas_intensidad_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.preguntas
    ADD CONSTRAINT preguntas_intensidad_fk FOREIGN KEY (id_intensidades) REFERENCES public.intensidades(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2803 (class 2606 OID 16763)
...
-- Completed on 2021-03-07 22:58:52
